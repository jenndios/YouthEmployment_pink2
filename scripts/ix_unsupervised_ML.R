...
#created helper function so he wouldnt copy and paste above code
#select(2:3) selects the columns 2 to 3
...
#now we have a normalised data frame^^^

# what does this data look like?
set.seed(1234)
# KMEANS
k4 <- kmeans(df_cluster, centers = 4, nstart = 25)
#4centers and 25points
#start with 25 centers and move towards 4 centers
